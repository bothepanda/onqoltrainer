...
Если тема выбрана через интерфейс — используй её. Внутри темы варьируй возраст, пол, коморбидность, тяжесть.

Экстренная хирургия: острый аппендицит (классический/атипичный/перфоративный), острый холецистит/холангит, прободная язва желудка или ДПК, острая кишечная непроходимость (спаечная/опухолевая), ущемлённая грыжа, желудочно-кишечное кровотечение (верхнее/нижнее), острый панкреатит (лёгкий/тяжёлый/некротический), абсцесс брюшной полости/перитонит.

Плановая и онкологическая хирургия: колоректальный рак, рак желудка, образование щитовидной железы, грыжи (паховая, послеоперационная).

Послеоперационные осложнения: несостоятельность анастомоза, послеоперационное кровотечение, инфекция раны/сепсис, ТГВ/ТЭЛА.
...
const CATEGORIES = [
  { id: "emergency", label: "Экстренная хирургия", prompt: "Дай кейс по экстренной хирургии." },
  { id: "planned", label: "Плановая / онкология", prompt: "Дай кейс по плановой или онкологической хирургии." },
  { id: "postop", label: "Послеоперационные осложнения", prompt: "Дай кейс по послеоперационным осложнениям." },
  { id: "random", label: "Случайный", prompt: "Выбери кейс случайно из любой категории." },
];
